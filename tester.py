...
def WGAN_tester(opt):
    ...
    def load_model_generator(net, epoch, opt):
        model_name = 'track_v4_deepfillv2_WGAN_G_epoch40_batchsize4.pth'
    ...
    # configurations
    results_path = './mask/alarm_v2/results'
    # results_path = './results/track_v4_deepfillv2_WGAN_G_epoch40_batchsize4'
    ...
    # ----------------------------------------
    # Testing loop
    for batch_idx, (img, mask, img_name) in enumerate(dataloader):
        ...
        utils.save_sample_png(sample_folder = results_path, sample_name = img_name, img_list = img_list, name_list = name_list, pixel_max_cnt = 255)
