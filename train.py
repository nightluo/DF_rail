...
Date: 2023-02-17 09:08:26
LastEditors: nightluo 1872194982@qq.com
LastEditTime: 2023-03-31 14:00:49
FilePath: /road/DeepFillv2_Pytorch/train.py
...
if __name__ == "__main__":
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = "./dataset", help = 'the training folder')
